...
https://ui.dev/amiresponsive?url=https://mlr-shop.herokuapp.com
...
[GitHub Issues](https://github.com/onabz/mlr-shop/issues) served as an another Agile tool.
...
- From **User Groups**, click **Create New Group**.
	- Suggested Name: `group-mlr-shop` (group + the project name)
...
- From the **JSON** tab, select the **Import Managed Policy** link.
	...
	- Click **Review Policy**.
	- Suggested Name: `policy-mlr-shop` (policy + the project name)
	- Provide a description:
		- "Access to S3 Bucket for mlr-shop static files."
	- Click **Create Policy**.
- From **User Groups**, click your "group-mlr-shop".
- Click **Attach Policy**.
- Search for the policy you've just created ("policy-mlr-shop") and select it, then **Attach Policy**.
- From **User Groups**, click **Add User**.
	- Suggested Name: `user-mlr-shop` (user + the project name)
- For "Select AWS Access Type", select **Programmatic Access**.
- Select the group to add your new user to: `group-mlr-shop`
